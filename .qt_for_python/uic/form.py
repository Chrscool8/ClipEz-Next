...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.horizontalLayout_2 = QHBoxLayout(self.groupbox_videoinfo)
        ...
        self.table_simple = QTableWidget(self.tab_videoinfo_simple)
        if (self.table_simple.columnCount() < 2):
            self.table_simple.setColumnCount(2)
        __qtablewidgetitem = QTableWidgetItem()
        __qtablewidgetitem.setTextAlignment(Qt.AlignLeading|Qt.AlignVCenter);
        self.table_simple.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        __qtablewidgetitem1.setTextAlignment(Qt.AlignLeading|Qt.AlignVCenter);
        self.table_simple.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        self.table_simple.setObjectName(u"table_simple")
        sizePolicy3 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.table_simple.sizePolicy().hasHeightForWidth())
        self.table_simple.setSizePolicy(sizePolicy3)
        self.table_simple.setAlternatingRowColors(True)
        self.table_simple.setTextElideMode(Qt.ElideRight)
        self.table_simple.horizontalHeader().setStretchLastSection(True)

        self.gridLayout_4.addWidget(self.table_simple, 0, 0, 1, 1)
        ...
        self.horizontalLayout_2.addWidget(self.tabs_videoinfo)

        self.image_thumb = QLabel(self.groupbox_videoinfo)
        self.image_thumb.setObjectName(u"image_thumb")
        self.image_thumb.setMinimumSize(QSize(160, 90))
        self.image_thumb.setMaximumSize(QSize(160, 90))
        self.image_thumb.setPixmap(QPixmap(u"G:/Documents/GitHub/Download-and-Clip/assets/16x9.png"))
        self.image_thumb.setScaledContents(True)

        self.horizontalLayout_2.addWidget(self.image_thumb)
    ...
    def retranslateUi(self, Widget):
        ...
        self.lineedit_url.setText(QCoreApplication.translate("Widget", u"https://youtu.be/MBNvk9CA1j4", None))
        ...
        ___qtablewidgetitem = self.table_simple.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("Widget", u"key", None));
        ___qtablewidgetitem1 = self.table_simple.horizontalHeaderItem(1)
